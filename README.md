...
This repository contains the conceptual definition and theoretical framework for **Orchestration Actions**, 
...
├── LICENSE             # CC BY 4.0
├── paper/
│   └── orchestration-actions.tex    # LaTeX dissertation
├── whitepaper/
│   └── orchestration-actions.md     # White paper
└── translations/
    ├── de/             # German
    ├── en/             # English
    ├── tr/             # Turkish
...
```bibtex
@misc{vega2025orchestrationactions,
  author = {Vega, Adam Eren},
  title = {Orchestration Actions: A Conceptual Framework},
  year = {2025},
  publisher = {GitHub},
  url = {https://github.com/vegafoundation/orchestration-actions}
}
```
